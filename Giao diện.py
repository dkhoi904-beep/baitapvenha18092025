...
class SmartCanteenApp:
    def __init__(self, root):
        ...
        self.home_btn = tk.Button(self.root, text="🏠 Home", command=self.show_home,
                                bg="#3399ff", fg="white")
        self.home_btn.pack(side="bottom", pady=5, )
        self._tab_bgs = {}
    ...
    def start_app(self):
        ...
        self.notebook.add(self.tab3, text="🍽️ Suất Ăn Tùy Chọn")
        # Nút Âm thanh luôn hiện
        self.sound_btn = tk.Button(self.root, text="🔊 Tắt nhạc", command=self.toggle_music,
                                bg="#ff9933", fg="white")
        self.sound_btn.place(relx=1.0, x=-10, y=10, anchor="ne")
    ...
    def setup_tab1(self):
        ...
        ttk.Button(left_frame, text="✨ Nhận diện & Tính tiền", command=self.analyze_and_pay, style="Accent.TButton").pack(pady=80, fill="x")
